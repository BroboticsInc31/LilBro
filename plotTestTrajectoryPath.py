...
#                        print("%s released" % (button))
            ...
            #Reading position values from a file 
#            if button_states['x']:   
#                data = np.loadtxt('walking.txt',usecols=(0,1),skiprows=1)
#                print(data)
#
#                x = data[:,0]
#                y = data[:,1]
...
#                    time_.sleep(.5)
            ...
            if button_states['b']:
                walkPath = 0
                #Write file for positions 
                np.savetxt('walking.txt',np.c_[array2,array3],fmt="%.3f %.3f")
                np.savetxt('RightToLeft.txt',np.c_[array2,array3],fmt="%.3f %.3f")
