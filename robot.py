...
class robot():
    ...
    def __init__(self):
        ...
        global n, nh, leng_coeff1, leng_coeff2, alpha_coeff1, alpha_coeff2 
        n = 24
        nh = 7
    ...
    def setFootTrajectory(self,length,clearance,sweepAngle,secPerCycle):
        ...
        leng_coeff1 = np.inv(leng_rhs1)*leng_lhs1
        leng_coeff2 = np.inv(leng_rhs2)*leng_lhs2

        alpha_coeff1 = np.inv(alpha_rhs1)*alpha_lhs1
        alpha_coeff2 = np.inv(alpha_rhs2)*alpha_lhs2
